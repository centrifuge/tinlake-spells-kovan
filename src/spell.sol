...
contract TinlakeSpell {
    ...
    // Borrower addresses
    address public BT1_BORROWER = 0x0000000000000000000000000000000000000001;
    address public BT2_BORROWER = 0x0000000000000000000000000000000000000002;
    address public BT3_BORROWER = 0x0000000000000000000000000000000000000003;
    address public BT4_BORROWER = 0x0000000000000000000000000000000000000004;
    ...
    function execute() internal {
        ...
        // rely borrower as level 1 admins
     ...
     function fileRiskGroups(FeedLike feed) internal {
        ...
        feed.file("riskGroup", 0, 1000000000000000000000000000, 1000000031709791983764586504, 1000000001547125824454591578);
        // rate = 1 + (0.05116828/31536000) * 10^27 = 1000000001622590055809233891
        feed.file("riskGroup", 1, 1000000000000000000000000000, 1000000031709791983764586504, 1000000001622535514967021816);
        // rate = 1 + (0.05354077/31536000) * 10^27 = 1000000001697742262810755961
        feed.file("riskGroup", 2, 1000000000000000000000000000, 1000000031709791983764586504, 1000000001697766679350583460);
        // rate = 1 + (0.05590763/31536000) * 10^27 = 1000000001772819317605276509
        feed.file("riskGroup", 3, 1000000000000000000000000000, 1000000031709791983764586504, 1000000001772819317605276509);
        // rate = 1 + (0.05826891/31536000) * 10^27 = 1000000001847695015220700152
        feed.file("riskGroup", 4, 1000000000000000000000000000, 1000000031709791983764586504, 1000000001847695015220700152);
        // rate = 1 + (0.06062462/31536000) * 10^27 = 1000000001922394089294774226
        feed.file("riskGroup", 5, 1000000000000000000000000000, 1000000031709791983764586504, 1000000001922394089294774226);
        // rate = 1 + (0.06297480/31536000) * 10^27 = 1000000001996917808219178082
        feed.file("riskGroup", 6, 1000000000000000000000000000, 1000000031709791983764586504, 1000000001996917808219178082);
        // rate = 1 + (0.06531947/31536000) * 10^27 = 1000000002071266806189751395
        feed.file("riskGroup", 7, 1000000000000000000000000000, 1000000031709791983764586504, 1000000002071266806189751395);
        // rate = 1 + (0.06765865/31536000) * 10^27 = 1000000002145441717402333841
        feed.file("riskGroup", 8, 1000000000000000000000000000, 1000000031709791983764586504, 1000000002145441717402333841);
        // rate = 1 + (0.06999237/31536000) * 10^27 = 1000000002219443493150684932
        feed.file("riskGroup", 9, 1000000000000000000000000000, 1000000031709791983764586504, 1000000002219443493150684932);
        // rate = 1 + (0.07232066/31536000) * 10^27 = 1000000002293273084728564181
        feed.file("riskGroup", 10, 1000000000000000000000000000, 1000000031709791983764586504, 1000000002293273084728564181);
        // rate = 1 + (0.07464355/31536000) * 10^27 = 1000000002366931443429731101
        feed.file("riskGroup", 11, 1000000000000000000000000000, 1000000031709791983764586504, 1000000002366931443429731101);
        // rate = 1 + (0.07696104/31536000) * 10^27 = 1000000002440418569254185693
        feed.file("riskGroup", 12, 1000000000000000000000000000, 1000000031709791983764586504, 1000000002440418569254185693);
        // rate = 1 + (0.07927318/31536000) * 10^27 = 1000000002513736047691527144
        feed.file("riskGroup", 13, 1000000000000000000000000000, 1000000031709791983764586504, 1000000002513736047691527144);
        // rate = 1 + (0.08157999/31536000) * 10^27 = 1000000002586884512937595129
        feed.file("riskGroup", 14, 1000000000000000000000000000, 1000000031709791983764586504, 1000000002586884512937595129);
        // rate = 1 + (0.08388148/31536000) * 10^27 = 1000000002659864282090309488
        feed.file("riskGroup", 15, 1000000000000000000000000000, 1000000031709791983764586504, 1000000002659864282090309488);
        // rate = 1 + (0.08617769/31536000) * 10^27 = 1000000002732676623541349569
        feed.file("riskGroup", 16, 1000000000000000000000000000, 1000000031709791983764586504, 1000000002732676623541349569);
        // rate = 1 + (0.08846865/31536000) * 10^27 = 1000000002805322488584474886
        feed.file("riskGroup", 17, 1000000000000000000000000000, 1000000031709791983764586504, 1000000002805322488584474886);
        // rate = 1 + (0.09075436/31536000) * 10^27 = 1000000002877801877219685439
        feed.file("riskGroup", 18, 1000000000000000000000000000, 1000000031709791983764586504, 1000000002877801877219685439);
        // rate = 1 + (0.09303486/31536000) * 10^27 = 1000000002950116057838660578
        feed.file("riskGroup", 19, 1000000000000000000000000000, 1000000031709791983764586504, 1000000002950116057838660578);
        // rate = 1 + (0.09531018/31536000) * 10^27 = 1000000003022265981735159817
        feed.file("riskGroup", 20, 1000000000000000000000000000, 1000000031709791983764586504, 1000000003022265981735159817);
        // rate = 1 + (0.09758033/31536000) * 10^27 = 1000000003094251966007102993
        feed.file("riskGroup", 21, 1000000000000000000000000000, 1000000031709791983764586504, 1000000003094251966007102993);
        // rate = 1 + (0.09984533/31536000) * 10^27 = 1000000003166074644850329782
        feed.file("riskGroup", 22, 1000000000000000000000000000, 1000000031709791983764586504, 1000000003166074644850329782);
        // rate = 1 + (0.10210522/31536000) * 10^27 = 1000000003237735286656519533
        feed.file("riskGroup", 23, 1000000000000000000000000000, 1000000031709791983764586504, 1000000003237735286656519533);
        // rate = 1 + (0.10436002/31536000) * 10^27 = 1000000003309234525621511923
        feed.file("riskGroup", 24, 1000000000000000000000000000, 1000000031709791983764586504, 1000000003309234525621511923);
        // rate = 1 + (0.10660973/31536000) * 10^27 = 1000000003380572361745306951
        feed.file("riskGroup", 25, 1000000000000000000000000000, 1000000031709791983764586504, 1000000003380572361745306951);
        // rate = 1 + (0.10885440/31536000) * 10^27 = 1000000003451750380517503805
        feed.file("riskGroup", 26, 1000000000000000000000000000, 1000000031709791983764586504, 1000000003451750380517503805);
        // rate = 1 + (0.11109405/31536000) * 10^27 = 1000000003522769216133942161
        feed.file("riskGroup", 27, 1000000000000000000000000000, 1000000031709791983764586504, 1000000003522769216133942161);
        // rate = 1 + (0.11332868/31536000) * 10^27 = 1000000003593628868594622019
        feed.file("riskGroup", 28, 1000000000000000000000000000, 1000000031709791983764586504, 1000000003593628868594622019);
        // rate = 1 + (0.11555834/31536000) * 10^27 = 1000000003664330923389142567
        feed.file("riskGroup", 29, 1000000000000000000000000000, 1000000031709791983764586504, 1000000003664330923389142567);
        // rate = 1 + (0.11778303/31536000) * 10^27 = 1000000003734875380517503805
        feed.file("riskGroup", 30, 1000000000000000000000000000, 1000000031709791983764586504, 1000000003734875380517503805);
     }
}
